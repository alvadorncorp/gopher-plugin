...
autoloadSkills: developer
---

Load the autoloaded `developer` skill. Logical owner is `gopher:developer`. That
skill owns the detection, the pattern decision, the validation ladder, and the
shape of the result. Do not restate any of it here. Resolve every reference
