...
4. Modernization. Adopt declared-version-safe idioms and API updates, preview
   first.
5. Whole-scope validation and a fresh review. Re-measure every dimension and run
...
- Test safety precedes complexity and modernization because both change code the
  tests must already protect.
