...
work. For a version `1`, `2`, or `3` file with no `[developer]` table, resolve
the missing values to `idiom_policy = "latest-compatible"` and
`test_workflow = "adaptive-tdd"` from `references/schema.md` and
